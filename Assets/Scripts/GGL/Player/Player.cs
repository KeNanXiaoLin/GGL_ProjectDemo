...
public class Player : MonoBehaviour
{
    ...
    private void DoSpecialInteractOutWorld()
    {
        switch (currentMaskData.maskType)
        {
            ...
            case E_MaskType.Streetlight:
                MusicMgr.Instance.PlaySound("灯附身音效");
                break;
            case E_MaskType.Human:
                // 游戏胜利
                MusicMgr.Instance.PlayBKMusic("通关界面");
    ...
    private void DoMove()
    {
        ...
        {
            transform.Translate(moveDir * currentMaskData.moveSpeed * Time.deltaTime);
            switch (currentMaskData.maskType)
            {
                case E_MaskType.Mouse:
    ...
    /// <summary>
    /// 离开这个场景，需要清空GameManager中的数据
    /// </summary>
    private void GameEnd()
    {
        MusicMgr.Instance.PlaySound("游戏失败音效");
        MusicMgr.Instance.PlayBKMusic("失败界面");
        GameManager.Instance.ClearGameSceneData();
        // SceneManager.LoadScene(Setting.END_SCENE_NAME);
    ...
    private void AttachToOther(Cell targetCell)
    {
        ...
        MusicMgr.Instance.PlaySound("附身交互音效");
    }
